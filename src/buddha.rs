...
pub struct Buddha {
    ...
    samples: Vec<DVec2>,
    view: View,
    cheched_samples: Receiver<PointType>,
...
impl Buddha {
    pub fn new(
        ...
        let (work_tx, work_rx) = flume::bounded(64);
        ...
        let mut buddha = Self {
            ...
            cheched_samples: checked_samples_rx,
        };
    ...
    fn replenish_samples(&mut self) {
        self.samples = match self.cheched_samples.recv().unwrap() {
